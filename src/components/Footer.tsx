        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <h3 className="text-2xl font-bold mb-4">
              <span className="text-blue-400">Inmo</span>Plus
            </h3>
            <p className="text-gray-400 mb-6 leading-relaxed">
              Más de 15 años conectando personas con sus hogares ideales. 
              Tu confianza es nuestro compromiso.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="#properties" className="text-gray-400 hover:text-blue-400 transition-colors">
                  Propiedades
                </a>
              </li>
              <li>
